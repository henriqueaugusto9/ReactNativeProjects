        ...
        <View style={styles.resultados}>
          <View style={styles.viewUp}>
            ...
            <View style={styles.conteudoComBordas}>
              ...
              <Text style={styles.textGreen}>{this.props.state.vitorias}</Text>
            </View>

            <View style={styles.conteudo}>
              <Text style={styles.titulo}>Derrotas</Text>
              <Text style={styles.textRed}>{this.props.state.derrotas}</Text>
            </View>
          </View>
        </View>
        {
          this.props.state.partida.map(item => (
            <View key={item} style={styles.container}>
              ...
              <View style={styles.informacoesPartida}>
                ...
                <Text style={{ color: '#444343', fontSize: 14 }} >{item.nome} </Text>
